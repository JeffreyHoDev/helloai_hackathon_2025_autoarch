...
from .tools import save_terraform_file
...
terraform_agent = LlmAgent(
    ...
    description='A helpful assistant for providing terraform configurations for given context.',
    instruction=instructions,
    tools=[save_terraform_file]
)
