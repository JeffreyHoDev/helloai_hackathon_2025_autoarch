...
root_agent = Agent(
    ...
    sub_agents=[gcp_agent, cloud_arch_diagram_agent, cloud_arch_proposal_agent, file_proposal_agent, architecture_validator_agent, terraform_agent, cloud_cost_analysis_agent]
)
