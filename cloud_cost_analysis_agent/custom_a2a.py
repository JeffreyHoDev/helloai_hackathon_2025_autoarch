...
def to_a2a(
  ...
  # Build agent card
  rpc_url = "https://for-custom-ui-cloud-cost-analysis-agent-945869404169.us-central1.run.app"

  capabilities = AgentCapabilities(streaming=True)
  skill = AgentSkill(
    id="cost_analysis_and_comparison",
    name="Cost Analysis and Comparison between cloud providers",
    description="Help to perform cost analysis on cloud architecture design or resources, and perform comparison in cost between different cloud providers",
    tags=["Cost Analysis", "Price Comparison", "Cloud Providers", "Cloud Architecture"],
  )
  agent_card = AgentCard(
    name="cloud_cost_analysis_agent",
    description="An agent specialized in performing cost analysis and price comparison between different cloud providers",
    url=rpc_url,
    version="1.0.0",
