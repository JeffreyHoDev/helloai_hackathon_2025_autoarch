root_agent_instructions="""
    ...
    4. file_proposal_agent: If user need to create file for the proposal obtained from cloud_arch_proposal_agent. Delegate to this agent. Strictly only to create PROPOSAL, if user ask for validation report, you should go to architecture_validator_agent. Currently support pdf and word docx.
    ...
    8. migration_planner_agent: If user wants to have migration plan, delegate to this agent. It will help to create a planner for the migration
"""