...
def to_a2a(
  ...
  # Build agent card
  rpc_url = "https://diagrams-code-builder-service-945869404169.us-central1.run.app"

  capabilities = AgentCapabilities(streaming=True)
  skill = AgentSkill(
    id="diagrams_code_build",
    name="Diagrams Code Building",
    description="Generate the python code with Diagrams library",
    tags=["Diagrams", "Python", "Code", "Cloud Architecture"],
  )
  agent_card = AgentCard(
    name="diagrams_code_builder_agent",
    description="An agent specialized in generating python code and with Diagrams python library that can be used later for creating cloud architecture diagram",
    url=rpc_url,
    version="1.0.0",
